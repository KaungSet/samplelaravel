...
<html lang="en">
	...
	<head>
		...
		<!--favicon-->
		<link rel="icon" href="{{asset('assets/images/favicon2.png')}}" type="image/png" />
		<!-- loader-->
                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    ...
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <img src="assets/images/cloud9_logo.png" width="180" alt="" />
                        </div>
                        <div class="card">
                                ...
                                <div class="alert alert-danger border-0 bg-danger alert-dismissible fade show py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <div class="text-white">Wrong Username or Password!</div>
                                        </div>
                                    </div>
